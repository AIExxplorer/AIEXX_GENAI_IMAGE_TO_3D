# PowerShell script to create final launcher with UTF-8 BOM
# Only AIEXX signature uses Unicode characters
...
Write-Host "Launcher criado com sucesso!" -ForegroundColor Green
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Arquivo: $outputPath" -ForegroundColor Yellow
Write-Host "Encoding: UTF-8 com BOM (assinatura UNICODE)" -ForegroundColor Yellow
Write-Host ""

# Verify BOM
$bytes = [System.IO.File]::ReadAllBytes($outputPath)
if ($bytes[0] -eq 0xEF -and $bytes[1] -eq 0xBB -and $bytes[2] -eq 0xBF) {
    Write-Host "[OK] Assinatura UTF-8 BOM presente (EF BB BF)" -ForegroundColor Green
    Write-Host "[OK] Assinatura AIEXX preservada" -ForegroundColor Green
    Write-Host "[OK] Apenas caracteres ASCII para decoracao" -ForegroundColor Green
} else {
...
Write-Host "  00-LAUNCHER\START_AIEXX.bat" -ForegroundColor Yellow
Write-Host "================================================" -ForegroundColor Cyan
